...
exec "Snippet ref <a href=\"".st.et."\">".st.et."</a>"
...
exec "Snippet a <a href=\"".st.et."\"".st.et.">".st.et."</a>"
exec "Snippet charset <meta http-equiv=\"Content-type\" content=\"text/html; charset=utf-8\" />"
exec "Snippet html <html><CR><head><CR><title>".st.et."</title><CR></head><CR><body>".st.et."</body><CR></html>"
exec "Snippet img <img src=\"".st.et."\">".st.et."</img>"
